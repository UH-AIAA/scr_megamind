...
// init queues
void init_GDQ() {
    GDQ.sensors = xQueueCreate(MAX_SENSOR_QUEUE_SIZE * 4, sizeof(GDQMessage_t));
...
void SD_task(void *pvParameter)
{
    ...
    static GDQMessage_t currentMessage;
    ...
    while(1)
    {
        ...
        currentMessage = xQueueReceive(GDQ.sensors, portMAX_DELAY);
